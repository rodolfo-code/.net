...
CREATE TABLE [Post] (
    ...
    [LastUpdateDate] SMALLDATETIME NOT NULL DEFAULT '2023-04-19T00:38:33.9590208Z',
...
VALUES (N'20230419003834_InitialCreation', N'7.0.4');
GO
...
ALTER TABLE [Post] ADD DEFAULT '2023-04-19T00:45:47.9498242Z' FOR [LastUpdateDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230419004548_AdicionadoCampoGithub', N'7.0.4');
GO
